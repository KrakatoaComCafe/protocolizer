...
class MessageInterpretFactoryTest {
    ...
    public MessageInterpretFactoryTest() {
        ...
        this.protocolDefinitionFactory = mock(ProtocolDefinitionFactory.class);
        this.messageValuesFactory = mock(MessageValuesFactory.class);
        this.messageInterpretFactory = new MessageInterpretFactory(this.fieldDefinitionFactory, this.protocolDefinitionFactory, this.messageValuesFactory);
    }
    ...
    void given_OneNewField_When_create_Then_ReturnStringWithOverwriteFieldValue() {
        ...
        ProtocolDefinition protocolDefinition = mock(ProtocolDefinition.class);
        ...
        doReturn(protocolDefinition)
            .when(this.protocolDefinitionFactory)
